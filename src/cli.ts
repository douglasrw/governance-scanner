...
import type { ScanResult, Dimension, Finding } from "./scanner.js";
...
const bgRed = (s: string) => `\x1b[41m\x1b[97m${s}\x1b[0m`;
const bgGreen = (s: string) => `\x1b[42m\x1b[97m${s}\x1b[0m`;
const bgYellow = (s: string) => `\x1b[43m\x1b[30m${s}\x1b[0m`;
const bgBlue = (s: string) => `\x1b[44m\x1b[97m${s}\x1b[0m`;
...
function gradeColor(grade: string): (s: string) => string {
  switch (grade) {
    ...
    case "D": return red;
    case "F": return (s: string) => bgRed(` ${s} `);
    default: return dim;
  }
}
...
function getResultId(repoName: string): string {
